...
export class TccPaths {
    ...
    static readonly TCCD_PYTHON_CAMERACTRL_FILE: string =
        '/opt/shiroikuma-tuxedo-control-center/resources/dist/tuxedo-control-center/data/camera/cameractrls.py';
    ...
    static readonly V4L2_NAMES_FILE: string =
        '/opt/shiroikuma-tuxedo-control-center/resources/dist/tuxedo-control-center/data/camera/v4l2_kernel_names.json';
